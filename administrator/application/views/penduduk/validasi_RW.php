                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" data-target="#modal-show<?=$val->NIK;?>" class="btn btn-info btn-xs" data-popup="tooltip" title="Detail" data-placement="top" ><i class="fa fa-tripadvisor"></i></a>

                                            <a data-toggle="modal" data-target="#modal-validasi<?=$val->NIK;?>" class="btn btn-info btn-xs" data-popup="tooltip" title="Validasi" data-placement="top" ><i class="fa fa-check-square-o"></i></a>

                                            <a href="<?php echo site_url('admin/hapus_rw/'.$val->no_pengantar); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');" class="btn btn-info btn-xs tooltips" data-popup="tooltip" title="Hapus" data-placement="top"><i class="glyphicon glyphicon-trash"></i></a>
                                    </tr>
                                     <?php endforeach;?>
                                </tbody>
                             </table>
...
<!-- Modal Validasi -->
<?php $no=  0; foreach($pengantar as $val ): $no++;?>
<div id="modal-validasi<?=$val->NIK;?>" class="modal fade">
    <div class="modal-dialog">
      <form action="<?php echo site_url('admin/valrw'); ?>" method="post">
      <div class="modal-content">
            ...
            <div class='col-md-9'><input type="text" readonly value="<?=$val->nama;?>" name="nama" autocomplete="off" class="form-control"
              ...
              <div class="form-group">
                <label class='col-md-3'>Masa Berlaku</label>
                  <div class='col-md-9'> <input type="text" name="tanggal_berlaku" autocomplete="off" readonly value="<?=$val->tanggal_berlaku;?>" placeholder="Berlaku Sampai" class="form-control"
              required="" >
                    </div>
                </div>
                <!-- /.input group -->
              ...
              <select name="status_rw" class="form-control">
                    <option value="">Validasi RW</option>
